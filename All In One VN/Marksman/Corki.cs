...
namespace VnHarry_AIO.Marksman
{
    internal class Corki : PluginBase
    {
        ...
        public override sealed void _SetupMenu()
        {
            ...
            Variables.Config.Add("commbo.userstacks", new Slider("Lưu trữ x Rockets", 1, 0, 7));
            ...
            Variables.Config.Add("harass.userstacks", new Slider("Lưu trữ x Rockets", 4, 0, 7));
            Variables.Config.AddGroupLabel("Misc");
            Variables.Config.Add("misc.autor", new CheckBox("Tự dộng R"));
            Variables.Config.Add("misc.antigapcloser", new CheckBox("Sử dụng W trong Gapcloser", false));
