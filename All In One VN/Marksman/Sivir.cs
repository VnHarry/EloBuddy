...
namespace VnHarry_AIO.Marksman
{
    internal class Sivir : PluginBase
    {
        ...
        public override sealed void _SetupMenu()
        {
            ...
            Variables.Config.Add("harass.w", new CheckBox("Sử dụng W trong Harass", false));
            ...
            Variables.Config.Add("misc.autoq", new CheckBox("Tự động Q"));
            Variables.Config.Add("misc.autoe", new CheckBox("Tự động E"));
            Variables.Config.Add("misc.antigapcloser", new CheckBox("Sử dụng E trong Gapcloser"));
